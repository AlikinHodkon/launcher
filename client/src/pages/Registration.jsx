...
export default function Registration() {
  ...
  return (
    <div className='flex justify-center items-center min-h-[92vh]'>
        <form className=''>
            <h3 className='text-white text-[24px]'>Registration</h3>
            ...
            <input type='submit' onClick={(e) => {e.preventDefault(); dispatch(registration({"email": email.current.value, "password": password.current.value})); navigate('/')}} value={"Send"} />
        </form>
    </div>
  )
}
